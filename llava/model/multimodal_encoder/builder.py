...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    if (
        ...
        if use_s2:
            return SiglipVisionTowerS2(vision_tower, args=vision_tower_cfg)
        else:
            return SiglipVisionTower(vision_tower, args=vision_tower_cfg)


def build_vision_tower_legacy(vision_tower_cfg, **kwargs):
    vision_tower = getattr(
        vision_tower_cfg,
        "mm_vision_tower",
        getattr(vision_tower_cfg, "vision_tower", None),
